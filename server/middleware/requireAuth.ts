...
export function requireEdit(_req: Request, res: Response, next: NextFunction) {
...
export function requireDelete(_req: Request, res: Response, next: NextFunction) {
  const user = res.locals.user as TokenPayload | undefined
...
export function requireUserAdmin(_req: Request, res: Response, next: NextFunction) {
  const user = res.locals.user as TokenPayload | undefined
